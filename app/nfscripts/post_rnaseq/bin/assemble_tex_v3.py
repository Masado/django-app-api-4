...
parser.add_argument("-s", "--species", help='Path to the species.tex file.')
...
with open("%s/report3.tex" % out_path,'w') as f:
	...
	'\\begin{center}\n'
		'\\huge\n'
		'\\textbf{Analysis report of RNA-Seq data from \input{%s}}\n' % species)
	f.write('\\end{center}\n'
	'\n'
	...
	f.write('\\caption[Sequence Quality Histogram]{\input{%s}}\n' % species)
	f.write('\\end{figure}\n'
	'\\FloatBarrier\n'
	'\n'
	'\\begin{figure}[h]\n'
	...
	f.write('\\caption[Per Sequence Quality Scores]{\input{%s}}\n' % species)
	f.write('\\end{figure}\n'
	'\\FloatBarrier\n'
	'\n'
#	'\\begin{figure}[h]\n'
...
#	'\n'
	...
	f.write('\\caption[Per Base N Content]{\input{%s}}\n' % species)
	f.write('\\end{figure}\n'
	'\\FloatBarrier\n'
	'\n'
	'\\subsection*{Trimming}\n'
	...
	f.write('\\caption[Lengths of Trimmed Sequences]{\input{%s}}\n' % species)
	f.write('\\end{figure}\n'
	'\\FloatBarrier\n'
	'\n'
	'\\newpage\n'
	...
	f.write('\\caption[Alignment Sequences]{\input{%s}}\n' % species)
	f.write('\\end{figure}\n'
	'\\FloatBarrier\n'
	'\n'
	'\\newpage\n'
	...
	f.write('\\caption[Biotype Counts]{\input{%s}}\n' % species)
	f.write('\\end{figure}\n'
	'\\FloatBarrier\n'
	'\n'
	'\\newpage\n'
	...
	f.write('\\caption[Genomic Origin]{\input{%s}}\n' % species)
	f.write('\\end{figure}\n'
	'\\FloatBarrier\n'
	'\n'
	'\\newpage\n'
	...
	f.write('\\caption[DupRadar General Linear Models]{\input{%s}}\n' % species)
	f.write('\\end{figure}\n'
	'\\FloatBarrier\n'
	'\n'
...
#	'\n'
	...
	f.write('\\caption[Complexity Curve]{\input{%s}}\n' % species)
	f.write('\\end{figure}\n'
	'\\FloatBarrier\n'
	'\n'
	'\\newpage\n'
...
#	'\\FloatBarrier\n'
	...
	f.write('\\caption[KeyPathwayMiner computed pathway]{\input{%s}}\n' % species)
	f.write('\\end{figure}\n'
	'\n'
	'\\newpage\n'
